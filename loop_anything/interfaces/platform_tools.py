        ...
        if name == 'set_loop':
            ...
            if node == '$notifications':
                ...
                if a.get('unbind'):
                    ...
                    if 'kind' in a:
                        candidates['options'][ident] = {k: a[k] for k in ('kind', 'command', 'observe', 'cwd', 'timeout', 'event') if k in a}
