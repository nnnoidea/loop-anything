...
function openTaskEdit(kind,id=null){
  ...
  taskEdit={kind,id,runId:run.id,revision:run.revision,key:crypto.randomUUID(),changes:null};$('task-edit-error').textContent=(run.agent_sessions||[]).length?'Agent 正在处理工作；只有重叠范围的编辑需等待。':'';
