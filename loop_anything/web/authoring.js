...
document.addEventListener('change',event=>{
  const el=event.target;if(el.matches('[data-schema-type]')){const root=el.closest('.schema-form');root.querySelector(':scope > [data-schema-children]').innerHTML=schemaChildren({type:el.value});}
